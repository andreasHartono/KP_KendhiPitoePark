<?php namespace App\Http\Controllers;
	...
	class AdminAccounts1Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Is Admin","name"=>"is_admin"];
			...
			$this->form[] = ['label'=>'Is Admin','name'=>'is_admin','type'=>'number','validation'=>'required|integer','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Emoney','name'=>'emoney','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
