<?php namespace App\Http\Controllers;
	...
	class AdminUsers21Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Emoney","name"=>"emoney"];
			...
			//$this->form[] = ["label"=>"Emoney","name"=>"emoney","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
