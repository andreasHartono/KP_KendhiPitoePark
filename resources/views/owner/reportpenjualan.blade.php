...
<div class="row col-12">
    <form class="form-inline was-validated" action="{{ route('report_penjualan') }}">
        {{-- @csrf --}}
...
<div class="card">
    <div class="card-header">
        <h3 class="card-title"><b>Tabel penjualan semua menu pada {{ $tanggal }} :</b></h3>
    </div>
        ...
        <table class="table table-hover table-bordered" id="example1">
            ...
            <tbody id="tbody_all_rekapan">
                ...
                <tr>
                    ...
                    <!-- <td><button onclick="lihatdetail({{ $order->id }})" class="btn btn-success btn-block" data-toggle="modal" data-target="#modal-lg">
...
<div class="card-footer">
    <h3 id="grandTotal">Grand Total : <b>Rp. {{ number_format($total) }}</b></h3>
</div>
