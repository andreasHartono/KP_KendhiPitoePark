                    ...
                    <div id="contain">
                        ...
                        <div class="card card-1" id="cart_{{ $details['id'] }}">
                            <div class="card-body card-body-1">
                                <img src="{{ asset('assets/images/menu/' . $details['image']) }}" alt="menu" class="img-responsive">
                                <div class="text-section">
                                    <h4 class="title title-1">{{ $details['name'] }}</h4>
                                    <p class="card-text card-text-1">
                                        <b>Harga per Menu:</b><br>Rp.<b>{{ $details['price'] }}</b>
                                        <br> <b>Sub Total:</b><br>
                                        Rp.<b id="sub_total_{{ $details['id'] }}">{{ $details['price'] * $details['quantity'] }}</b>
                                    </p>
                                </div>&nbsp;&nbsp;&nbsp;&nbsp;
                                <div class="cta-section d-grid gap-2">
                                    <div class="checkout-quantity">
                                        ...
                                        <div class="product-quantity d-inline-flex">
                                            ...
                                            <button type="button" id="sub btnaddcart" class="sub" onclick="removeFromCart('{{ $details['id'] }}')">
                                        ...
                                        <a class="delete d-flex justify-content-center" onclick="deleteFromCart('{{ $details['id'] }}')">
                        ...
                        <div class="card card-1 checkout-total d-flex flex-wrap">
                            <div class="card-header">
                                <h4 class="card-title">Total Pembayaran : Rp. <span id="grand_total">{{ $total }}</span></h4>
                            </div>
                            <div class="card-body card-body-1">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="{{ route('index') }}" class="main-btn primary-btn"> <img src="{{ asset('template/assets/images/icon-svg/cart-9.svg') }}" alt="logo cart">Silahkan Pilih Menu</a>
                            </div>
                        </div>
                        @endif
    ...
    function addToCart(id) {
        $.ajax({
            ...
            success: function(response) {
                $('#msg-notif').html('<div class="alert alert-success" role="alert"><b>' + response['msg'] + '</b></div>');
