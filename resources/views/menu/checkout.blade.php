        ...
        <div class="card card-1">
            ...
            <div class="card-body card-body-1">
                ...
                <form action="{{ route('checkout_tunai') }}" method="POST" class="was-validated">
                    ...
                    @guest
                    <input type="text" class="form-control" placeholder="Tulis Nama Anda" name="nama_customer" id="nama_customer" required>
                    @endguest
                    ...
                    <p>Nomor Meja : &nbsp;&nbsp;<input type="number" class="form-control" value="{{ session('meja') }}" name="no_meja" id="no_meja" min='1' max={{ $noMejaMax }} required disabled></p>
