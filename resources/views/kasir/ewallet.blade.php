    ...
    <div class="card">
        <div class="card-body">
            ...
            <!-- <form action="#" method="POST" class="was-validated"> -->
                <div class="mb-3">
                    <input type="number" name="nominaltopup" class="form-control" id="inputNominal" placeholder="Masukkan Nominal Top Up misal : 10000">
                    {{-- <div class="invalid-feedback"></div>    --}}
                    <button id="generatekode" class="btn btn-success btn-block">BUAT KODE TOP UP</button>
                </div>
            <!-- </form> -->
        </div>
    </div><br>
