...
<div class="container">
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="card-title heading-6">Status Pesanan : <span class="text-danger"> {{ $dataOrder->status_order }}</span></h4>

            @else
            <h4 class="card-title heading-6">Status Pesanan : <span class="text-success"> {{ $dataOrder->status_order }}</span></h4>
            @endif
        </div>
    </div><br>
    <div class="card">
